...
router = APIRouter()
GROUP_EXAMPLE_NESTED = {'id': 1, 'code': 'G001', 'name': 'Java Region Stores', 'description': 'Stores located in Java', 'status': True, 'sort_order': 1}
TIER_EXAMPLE_NESTED = {'id': 1, 'code': 'GOLD_TIER', 'name': 'Gold Tier Dealer', 'description': 'High volume premium stores', 'level': 3, 'credit_limit': 500000000.0, 'status': True, 'sort_order': 1}
CHANNEL_GROUP_EXAMPLE_NESTED = {'id': 1, 'code': 'ONLINE_CH', 'name': 'Online Sales Channels', 'description': 'Marketplaces and Webstore Group', 'status': True, 'sort_order': 1}
STORE_EXAMPLE_NESTED = {'id': 1, 'store_group_id': 1, 'tier_id': 1, 'code': 'STR001', 'name': 'Royal Mattress Center Jakarta', 'owner_user_id': 1, 'credit_limit': 500000000.0, 'outstanding_balance': 15000000.0, 'address': 'Jl. Hayam Wuruk No. 12, Jakarta', 'phone': '021-1234567', 'email': 'jakarta@royalmattress.com', 'documents': ['https://example.com/siup.pdf'], 'payment_term': 30, 'status': True, 'sort_order': 1}
CHANNEL_EXAMPLE_NESTED = {'id': 1, 'store_id': 1, 'store_channel_group_id': 1, 'code': 'TOKOPEDIA_OFFICIAL', 'name': 'Tokopedia Official Store', 'description': 'Direct online channel via Tokopedia', 'status': True, 'sort_order': 1}
GROUP_EXAMPLE = {'id': 1, 'code': 'G001', 'name': 'Java Region Stores', 'description': 'Stores located in Java', 'status': True, 'sort_order': 1, 'created_at': '2026-07-09T13:00:00', 'updated_at': '2026-07-09T13:00:00', 'stores': [STORE_EXAMPLE_NESTED]}
TIER_EXAMPLE = {'id': 1, 'code': 'GOLD_TIER', 'name': 'Gold Tier Dealer', 'description': 'High volume premium stores', 'level': 3, 'credit_limit': 500000000.0, 'status': True, 'sort_order': 1, 'created_at': '2026-07-09T13:00:00', 'updated_at': '2026-07-09T13:00:00', 'stores': [STORE_EXAMPLE_NESTED]}
CHANNEL_GROUP_EXAMPLE = {'id': 1, 'code': 'ONLINE_CH', 'name': 'Online Sales Channels', 'description': 'Marketplaces and Webstore Group', 'status': True, 'sort_order': 1, 'created_at': '2026-07-09T13:00:00', 'updated_at': '2026-07-09T13:00:00', 'channels': [CHANNEL_EXAMPLE_NESTED]}
STORE_EXAMPLE = {'id': 1, 'store_group_id': 1, 'tier_id': 1, 'code': 'STR001', 'name': 'Royal Mattress Center Jakarta', 'owner_user_id': 1, 'credit_limit': 500000000.0, 'outstanding_balance': 15000000.0, 'address': 'Jl. Hayam Wuruk No. 12, Jakarta', 'phone': '021-1234567', 'email': 'jakarta@royalmattress.com', 'documents': ['https://example.com/siup.pdf'], 'payment_term': 30, 'status': True, 'sort_order': 1, 'created_at': '2026-07-09T13:00:00', 'updated_at': '2026-07-09T13:00:00', 'group': GROUP_EXAMPLE_NESTED, 'tier': TIER_EXAMPLE_NESTED, 'channels': [CHANNEL_EXAMPLE_NESTED]}
CHANNEL_EXAMPLE = {'id': 1, 'store_id': 1, 'store_channel_group_id': 1, 'code': 'TOKOPEDIA_OFFICIAL', 'name': 'Tokopedia Official Store', 'description': 'Direct online channel via Tokopedia', 'status': True, 'sort_order': 1, 'created_at': '2026-07-09T13:00:00', 'updated_at': '2026-07-09T13:00:00', 'store': STORE_EXAMPLE_NESTED, 'channel_group': CHANNEL_GROUP_EXAMPLE_NESTED}
