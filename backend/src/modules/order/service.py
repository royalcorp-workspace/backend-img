        ...
        "items": [
            {
                ...
                "color_id": (item.meta or {}).get("color_id") if item.meta else None,
                "color_name": (item.meta or {}).get("color_name") if item.meta else None,
                "color_code": (item.meta or {}).get("color_code") if item.meta else None,
                "meta": item.meta,
