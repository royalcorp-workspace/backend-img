...
PAYMENT_METHOD_EXAMPLE = {'id': '019f5933-08c8-7082-b1cd-7185cff32192', 'code': 'bca_va', 'name': 'BCA Virtual Account', 'type': 2, 'provider': 'Midtrans', 'image': 'https://example.com/bca.png', 'has_charge': True, 'charge_type': 1, 'charge_value': 4000.0, 'charge_bearer': 'customer', 'minimum_amount': 10000.0, 'maximum_amount': None, 'sort_order': 1, 'status': 1, 'bank_info': None, 'created_at': '2026-07-09T13:00:00', 'updated_at': '2026-07-09T13:00:00'}

@router.get('/', response_model=PaginatedListResponse[PaymentMethodRead], summary='List Payment Methods', description='Get a list of payment methods.', responses={200: {'description': 'A paginated list of payment methods', 'content': {'application/json': {'example': {'data': [PAYMENT_METHOD_EXAMPLE], 'total_count': 1, 'has_more': False, 'page': 1, 'items_per_page': 10}}}}, 401: {'description': 'Not authenticated', 'content': {'application/json': {'example': {'detail': 'Not authenticated', 'support_id': 'a1b2c3d4'}}}}, 403: {'description': 'Not authorized', 'content': {'application/json': {'example': {'detail': 'Not authorized', 'support_id': 'a1b2c3d4'}}}}})
