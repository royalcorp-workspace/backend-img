...
class Product(Base, TimestampMixin):
    ...
    warranty_duration: Mapped[str | None] = mapped_column(String(255), default=None)
    courier_type: Mapped[str | None] = mapped_column(String(50), default="keduanya")
    shipping_scheme: Mapped[str | None] = mapped_column(String(50), default="dimension")
    shipping_cost: Mapped[float | None] = mapped_column(default=0.0)
    length: Mapped[str | None] = mapped_column(String(50), default=None)
    width: Mapped[str | None] = mapped_column(String(50), default=None)
...
class ProductVariant(Base, TimestampMixin):
    ...
    width: Mapped[str | None] = mapped_column(String(255), default=None)
    length: Mapped[str | None] = mapped_column(String(255), default=None)
    height: Mapped[str | None] = mapped_column(String(255), default=None)
    weight: Mapped[str | None] = mapped_column(String(255), default=None)
    package_length: Mapped[float | None] = mapped_column(default=None)
    package_width: Mapped[float | None] = mapped_column(default=None)
    package_height: Mapped[float | None] = mapped_column(default=None)
    package_weight: Mapped[float | None] = mapped_column(default=None)
    creator: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), default=None)
    editor: Mapped[uuid.UUID | None] = mapped_column(UUID(as_uuid=True), default=None)
    deleted: Mapped[bool] = mapped_column(Boolean, default=False)
...
class ProductBundlingItem(Base, TimestampMixin):
    ...
    is_suggest: Mapped[bool] = mapped_column(Boolean, default=False)
    bundle_price: Mapped[float | None] = mapped_column(default=None)
    discount_percent: Mapped[float | None] = mapped_column(default=None)
    discount_nominal: Mapped[float | None] = mapped_column(default=None)
