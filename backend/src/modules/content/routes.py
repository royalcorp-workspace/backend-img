...
async def get_about_us(item_id: uuid.UUID, db: AsyncSessionDep, _: Annotated[dict[str, Any], Depends(require_permission('content:read'))], service: ContentServiceDep) -> dict[str, Any]:
...
async def get_blog_post(item_id: uuid.UUID, db: AsyncSessionDep, _: Annotated[dict[str, Any], Depends(require_permission('content:read'))], service: ContentServiceDep) -> dict[str, Any]:
...
async def get_faq(item_id: uuid.UUID, db: AsyncSessionDep, _: Annotated[dict[str, Any], Depends(require_permission('content:read'))], service: ContentServiceDep) -> dict[str, Any]:
...
async def get_how_to_return(item_id: uuid.UUID, db: AsyncSessionDep, _: Annotated[dict[str, Any], Depends(require_permission('content:read'))], service: ContentServiceDep) -> dict[str, Any]:
...
async def get_privacy_policy(item_id: uuid.UUID, db: AsyncSessionDep, _: Annotated[dict[str, Any], Depends(require_permission('content:read'))], service: ContentServiceDep) -> dict[str, Any]:
...
async def get_terms_and_condition(item_id: uuid.UUID, db: AsyncSessionDep, _: Annotated[dict[str, Any], Depends(require_permission('content:read'))], service: ContentServiceDep) -> dict[str, Any]:
