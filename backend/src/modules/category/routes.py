...
async def get_category(category_id: int, db: AsyncSessionDep, current_user: Annotated[dict[str, Any], Depends(get_current_user)], category_service: CategoryServiceDep) -> dict[str, Any]:
